//
//  StartWorkoutTimerVC.swift
//  FitnessApp
//
//  Created by Сергей Смирнов on 23.10.2022.
//

import UIKit

class StartWorkoutTimerVC: UIViewController {
    ...
    private let detailsView = DetailsTimerView(name: "Squats")
...
extension StartWorkoutTimerVC {
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            femaleImageView.widthAnchor.constraint(equalToConstant: 242),
            femaleImageView.heightAnchor.constraint(equalToConstant: 242),
